...
enum CharacterChatMessageItem: Hashable {
    ...
    static func from(dto: ChatDataDTO) throws -> CharacterChatMessageItem {
        ...
        case "USER":
            do {
                ...
                throw ChatDataModelError.invalidDateFormat(wrongValue: dto.createdAt)
            }
        case "ORB_CHARACTER":
            do {
                return .orbCharacter(
                ...
                throw ChatDataModelError.invalidTimeFormat(wrongValue: dto.createdAt)
            }
        default:
            throw ChatDataModelError.invalidRole(wrongValue: dto.role)
        }
    }
    ...
    static func decodeToDate(from dateString: String) throws -> Date {
        ...
        if let date = formatter.date(from: dateString) {
            ...
            throw ChatDataModelError.invalidDateFormat(wrongValue: dateString)
        }
    }
